" ### Plugins
" Installation Pluginmanager ("vim-plug")
" Wenn Du ein Plugin entfernst (ich kommentiere diese oft schnell mit " aus) 
" ist es zuerst deaktiviert. Möchtest Du es deinstallieren, kannst Du dies 
" mit :PlugClean machen. 
" Möchtest Du dies nicht haben, dann oberen Block entfernen und die Plugins 
" manuell mit :PlugInstall installieren.
" Mit 
"   :PlugDiff kannst Du schauen, ob es neue Versionen gibt und was sich geändert hat. 
" Durch 
"   :PlugUpdate spielst Du neue Updates ein. 
"   Vim-Plug selbst kannst Du mit :PlugUpgrade erneuern.
"
...
call plug#begin()
  ...
  Plug 'morhetz/gruvbox'              " Farbschema Alternative (Braun gehalten)
  Plug 'folke/tokyonight.nvim'        " Farbschema (dunkelblau)
